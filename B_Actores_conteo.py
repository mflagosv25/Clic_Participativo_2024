...
#-----------Adecuación inicial del texto -> Actores limpio
    act_inst = get_actores_limpio(df_actores)
#--------- Limpiar texto actores 
    act_inst = clean_actores(act_inst)
#--------- Realizar conteo del número de plazas
    act_inst = count_actores(act_inst)
#%%Guardar el archivo
#act_inst.to_excel("Actores_instancias.xlsx", index=False)
# =============================================================================
